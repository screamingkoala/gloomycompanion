...
MACROS =
    ...
    , "%symbol_mindthief%":                         "<img class='class_icon' src='images/Mindthief.svg' width='100%' height='100%'></span>"
    , "%symbol_Sunkeeper%":                         "<img class='class_icon' src='images/Sunkeeper.svg' width='100%' height='100%'></span>"
    , "%symbol_Quartermaster%":                     "<img class='class_icon' src='images/Quartermaster.svg' width='100%' height='100%'></span>"
    , "%symbol_Summoner%":                          "<img class='class_icon' src='images/Summoner.svg' width='100%' height='100%'></span>"
    , "%symbol_Nightshroud%":                       "<img class='class_icon' src='images/Nightshroud.svg' width='100%' height='100%'></span>"
    , "%symbol_Plagueherald%":                      "<img class='class_icon' src='images/Plagueherald.svg' width='100%' height='100%'></span>"
    , "%symbol_Berserker%":                         "<img class='class_icon' src='images/Berserker.svg' width='100%' height='100%'></span>"
    , "%symbol_Soothsinger%":                       "<img class='class_icon' src='images/Soothsinger.svg' width='100%' height='100%'></span>"
    , "%symbol_Doomstalker%":                       "<img class='class_icon' src='images/Doomstalker.svg' width='100%' height='100%'></span>"
    , "%symbol_Sawbones%":                          "<img class='class_icon' src='images/Sawbones.svg' width='100%' height='100%'></span>"
    , "%symbol_Elementalist%":                      "<img class='class_icon' src='images/Elementalist.svg' width='100%' height='100%'></span>"
    , "%symbol_Beast Tyrant%":                      "<img class='class_icon' src='images/BeastTyrant.svg' width='100%' height='100%'></span>"
